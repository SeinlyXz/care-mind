        ...
        <div class="shadow-xl rounded-2xl">
            <div class="bg-white px-16 py-8 md:px-48 md:py-36 rounded-2xl grid grid-cols-1 grid-flow-row gap-y-8 md:gap-y-10">
                ...
                <div class="flex gap-3 justify-center">
                    <a href="#" class="bg-teal-500 px-[30px] py-1 md:py-2 rounded-xl text-white text-md md:text-xl">Iya</a>
                    <a href="#" class="bg-teal-500 px-[30px] py-1 md:py-2 rounded-xl text-white text-md md:text-xl">Tidak</a>
                </div>
            </div>
        </div>
    </div>
